...
CONFIG_PACKAGE_luci-app-store=n                     # Store 应用商店
...
# 文件共享相关:
CONFIG_PACKAGE_luci-app-samba4=n                    # Samba4 网络共享（推荐）
CONFIG_PACKAGE_samba4-server=n                      # Samba4 服务器
CONFIG_PACKAGE_samba4-libs=n                        # Samba4 库文件
